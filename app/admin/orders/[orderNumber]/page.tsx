...
type CustomerNotificationHistoryView = {
  id?: string;
  actionId?: string;
  createdAt: string;
  orderStatus: string;
...
function customerNotificationSucceeded(entry: CustomerNotificationHistoryView) {
  const results = Object.values(entry.results || {});
  return results.length > 0 && results.every((result) => result.status === "sent");
}
