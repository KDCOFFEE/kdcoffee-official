  ...
  return <main className="admin-page">
    ...
    <section className="admin-detail-grid">
      ...
      <aside className="admin-panel admin-side-panel">
        <h2>履約處理</h2><FulfillmentOrderControls orderId={order.orderNumber} orderMode={order.orderMode} initial={fulfillment} initialPickupDate={order.studioPickup?.preferredDate} initialStore={order.store ? { id: String(order.store.id || ""), name: String(order.store.name || ""), address: String(order.store.address || "") } : undefined} />
